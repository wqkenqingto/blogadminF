;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoText: '总数：{0}',                                                        // text when all options are visible / false for no info text
      infoTextFiltered: '<span class="label label-warning">搜索结果</span> {0} from {1}', // when not all of the options are visible due to the filter
