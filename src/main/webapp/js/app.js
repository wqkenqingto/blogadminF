 ...
 * @returns {String}
 */
function displayImage(imageSrc, width, height) {
	if (typeof (imageSrc) != 'undefined' && null != imageSrc && imageSrc != "") {
		return "<img src='" + imageSrc + "' style='width:" + width + "px;height:" + height + "px'";
	}
	return "";
}
