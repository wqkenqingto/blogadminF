...
//                    PerformanceAdvisory.LOG.debug("Unable to initialize NativeIO libraries", t);
         ...
         * @throws java.io.IOException thrown if there was an IO error while obtaining the file stat.
         */
    ...
    public static class Windows {
         ...
         * @throws java.io.IOException I/O exception on error
         */
         ...
         * @see POSIX#mlock(java.nio.ByteBuffer, long)
         */
...
//                PerformanceAdvisory.LOG.debug("Unable to initialize NativeIO libraries", t);
     ...
     *
//     * @param  full principal name containing the domain
     ...
     *
     * @throws org.apache.hadoop.io.SecureIOUtils.AlreadyExistsException if the file already exists
     * @throws java.io.IOException if any other error occurred
     */
