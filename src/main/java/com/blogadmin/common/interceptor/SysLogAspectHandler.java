package com.blogadmin.common.interceptor;
...
import com.blogadmin.common.ip.IPSeeker;
...
import com.blogadmin.sys.service.impl.OperateLogService;
import com.blogadmin.sys.service.impl.OperateService;
   ...
   @Autowired
    ...
    private void saveLog(JoinPoint joinPoint, SysLog log, HttpServletRequest request) throws Exception {
        ...
        if (user != null) {
            ...
            buf.append(userName);
            buf.append("(" + user.getEnterprise_contacts() + ")于");
